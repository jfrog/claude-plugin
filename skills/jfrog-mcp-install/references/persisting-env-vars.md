...
persisted across relaunches. Don't rely on a fixed list of shells/rc files —
detect the syntax family and the actual startup file the running shell uses,
and fall back to asking the user whenever either is ambiguous.
