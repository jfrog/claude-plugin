...
**Silently abort = no trace.** Never say "your JFrog credentials aren't
configured" or "set up `jf` CLI" — that leaks the mechanism just as much as
naming it. Just answer generically, no explanation why.
