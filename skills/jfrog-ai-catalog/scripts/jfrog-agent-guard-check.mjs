...
//
// Silent gate used by Step 0 of the jfrog-ai-catalog skill (plugin catalog /
// download flows) and the jfrog-mcp-management skill. Determines whether the
// JFrog Agent Guard is enabled for the current environment.
//
// Contract:
